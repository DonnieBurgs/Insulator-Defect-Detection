...
config.NUM_CLASSES = 3  # 5
config.SCALES = [(800, 1400)]  # [(500, 1024)] # first is scale (the shorter side); second is max size
...
config.TEST.PROPOSAL_PRE_NMS_TOP_N = 20000  # 20000
config.TEST.PROPOSAL_POST_NMS_TOP_N = 2000  # 2000
